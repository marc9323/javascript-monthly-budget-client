...
var budgetController = (function() {
    ...
    return {
        ...
        deleteItem: function(type, id) {
            ...
            ids = data.allItems[type].map(function(current){ // map access current element, cur index, entire array, returns new array
                return current.id;
            });
            ...
            if(index !== -1){
                // delete
                data.allItems[type].splice(index, 1); // splice(index starting element, # items to delete)
            }
        },
        ...
        calculatePercentages: function() {
            data.allItems.exp.forEach(function(cur) {
                cur.calcPercentage(data.totals.inc);   /// differs*************************
            });
        },
      ...
      addListItem: function(object, type) {
        ...
        displayPercentages: function(percentages) {
            ...
            nodeListForEach(fields, function(current, index) {
                // display these percentages on page IF not zero or negative
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var updatePercentages = function() {
        ...
        // 2. Read percentages from the bedget controller
